    ...
    public void run(RobotController rc) throws GameActionException {
        ...
        if(rc.isActive()){
            ...
            if(go){
                ...
                System.out.println("heading to encampment");
                ...
                System.out.println("finding new encampment");
                int destinationDistance = 2147483647;
                MapLocation[] encampments = rc.senseAllEncampmentSquares();
                for(MapLocation EncampmentLocation : encampments) {
                    System.out.println("Checking encampment at "+EncampmentLocation.x+", "+EncampmentLocation.y);
                    if(EncampmentLocation.distanceSquaredTo(myLocation)<destinationDistance) {
                        this.destination = EncampmentLocation;
                        System.out.println("Found closer encampment at "+EncampmentLocation.x+", "+EncampmentLocation.y);
                    } else {
                        System.out.println("Encampment was further ("+EncampmentLocation.distanceSquaredTo(myLocation)+" Vs. "+destinationDistance+")");
                    }
                }
                if(this.destination!=this.enemyHQ) {
